...
<@layout.registrationLayout displayMessage=!messagesPerField.existsError('username','password') displayInfo=realm.password && realm.registrationAllowed && !registrationDisabled??; section>
    ...
    <#elseif section = "form">
        ...
        button.btn-primary {
            width: 100%;
            max-width: 200px; /* Limit the width for centering */
            padding: 16px;
            background: linear-gradient(135deg, #F4B331 0%, #F46531 100%);
            color: white;
            border: none;
            display: flex;
            justify-content: center;
            ...
            .${properties.kcInputClass!} input {
                width: 100%;
                padding: 16px 20px;
                border: 2px solid rgba(16, 110, 47, 0.1);
                border-radius: 12px;
                font-size: 16px;
            ...
            .${properties.kcInputClass!} input:focus {
                border-color: #db24a4ff;
                background: white;
                box-shadow: 0 0 0 4px rgba(102, 126, 234, 0.1);
                transform: translateY(-2px);
            }

            .${properties.kcButtonClass!}.${properties.kcButtonPrimaryClass!} {
                width: 100%;
                padding: 16px;
            ...
            .${properties.kcButtonClass!}.${properties.kcButtonPrimaryClass!}:hover {
                transform: translateY(-2px);
                box-shadow: 0 10px 25px rgba(102, 126, 234, 0.3);
            }
            ...
            .${properties.kcFormSocialAccountListItemClass!} {
                list-style: none;
            }

            .${properties.kcFormSocialAccountListButtonClass!} {
                width: 50px;
                height: 50px;
                border-radius: 50%;
                display: flex;
            ...
            .${properties.kcFormSocialAccountListButtonClass!}:hover {
                transform: translateY(-3px);
                box-shadow: 0 10px 25px rgba(0, 0, 0, 0.1);
                text-decoration: none;
            }

            .${properties.kcFormSocialAccountListButtonClass!} svg {
                width: 20px;
                height: 20px;
                fill: currentColor;
            }
        ...
        <div class="kc-container" style="display:flex; justify-content:center; margin: auto; align-item: center; ">
            <!-- LEFT PANEL -->
            <div class="kc-left">
                 <img src="${url.resourcesPath}/img/icons.png" alt="Secure" id="logo-stackquiz" />
                <img src="${url.resourcesPath}/img/secure.png" alt="Secure" />
            </div>
            ...
            <div class="kc-right">
                    ...
                    <form id="kc-form-login" class="kc-form" onsubmit="login.disabled = true; return true;" action="${url.loginAction}" method="post">
                        <#if !usernameHidden??>
                            <div class="form-group">
                                ...
                                <input tabindex="1" id="username" 
                                      style=" padding: 10px; border-radius:400px; margin-top:5px"
                                      placeholder='<#if !realm.loginWithEmailAllowed>${msg("username")}<#elseif !realm.registrationEmailAsUsername>${msg("stackquiz@gmail.com")}<#else>${msg("email")}
                                      </#if>'
                        ...
                        <div class="form-group">
                         <label>Password</label>
                            ...
                            style=" padding: 10px; border-radius:400px; margin-top:5px"
                             placeholder="${msg('Stackquiz@123#$#')}" name="password" type="password" autocomplete="off"
                                   aria-invalid="<#if messagesPerField.existsError('username','password')>true</#if>" />
                        ...
                        <div class="form-group" style="justify-content: center; display:flex; align-item: center; margin-bottom: 0px;">
                            <input type="hidden" id="id-hidden-input" name="credentialId" <#if auth.selectedCredential?has_content>value="${auth.selectedCredential}"</#if>/>
                            <input tabindex="4" class="btn-primary" name="login" id="kc-login" type="submit" value="${msg("doLogIn")}" style="margin-top: -30px; width:200px;display:flex; border-radius:400px;
                            justify-content: center;
                            align-items: center;
                            padding:10px;
                            "/>
                ...
                <#if realm.password && social.providers??>
                   <p>___________________OR Login With ________________</p>
                    <div class="social-login" style="margin-top: -20px;">
                        <#list social.providers as p>
                            <a id="social-${p.alias}" href="${p.loginUrl}" aria-label="${p.displayName}">
                                    ...
                                    <#switch p.alias>
                                        ...
                                        <#case "facebook">
                                            <svg aria-hidden="true" viewBox="0 0 448 512">
                                                <path fill="#4267B2" d="M448 56.7v398.5c0 13.7-11.1 24.7-24.7 24.7H309.1V306.5h58.2l8.7-67.6h-67v-43.2c0-19.6 5.4-32.9 33.5-32.9h35.8v-60.5c-6.2-.8-27.4-2.7-52.2-2.7-51.6 0-87 31.5-87 89.4v49.9h-58.4v67.6h58.4V480H24.7C11.1 480 0 468.9 0 455.3V56.7C0 43.1 11.1 32 24.7 32h398.5c13.7 0 24.8 11.1 24.8 24.7z"/>
                                            </svg>
                                            <#break>
                                        <#case "gitlab">
                                            <svg aria-hidden="true" viewBox="0 0 512 512">
                                                <path fill="#FC6D26" d="M29.782 199.732L256 493.714 8.074 309.699c-6.856-5.142-9.712-13.996-7.141-21.993l28.849-87.974zm75.405-174.806c-3.142-8.854-15.709-8.854-18.851 0L29.782 199.732h131.961L105.187 24.926zm56.556 174.806L256 493.714l94.257-293.982H161.743zm349.324 87.974l-28.849-87.974L256 493.714l247.926-184.015c6.855-5.142 9.711-13.996 7.141-21.993zm-85.404-262.78c-3.142-8.854-15.709-8.854-18.851 0l-56.555 174.806h131.961L425.663 24.926z"/>
                                            </svg>
                                            <#break>
                                        <#case "linkedin">
                                        ...
                                        <#case "bitbucket">
                                            <svg viewBox="0 0 512 512" aria-hidden="true">
                                                <path fill="#0052CC" d="M22.2 32A16 16 0 0 0 6 47.8a26.35 26.35 0 0 0 .2 2.8l67.9 412.1a21.77 21.77 0 0 0 21.3 18.2h325.7a16 16 0 0 0 16-13.4L505 50.7a16 16 0 0 0-13.2-18.3 24.58 24.58 0 0 0-2.8-.2L22.2 32zm285.9 297.8h-104l-28.1-147h157.3l-25.2 147z"/>
                                            </svg>
                                            <#break>
                                        <#case "instagram">
                                            <svg viewBox="0 0 448 512" aria-hidden="true">
                                ...
                                <#else>
                                    <img src="${url.resourcesPath}/img/${p.alias}.png" alt="${p.displayName}"/>
                                </#if>
                            </a>
                        </li>
                    </#list>
